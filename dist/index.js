...
function run(runArgs) {
    return __awaiter(this, void 0, void 0, function () {
        var configPath, invalidateCache, showHelp, showInfo, promptMode, configureApp, config, weatherString;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    configPath = runArgs.configPath, invalidateCache = runArgs.invalidateCache, showHelp = runArgs.showHelp, showInfo = runArgs.showInfo, promptMode = runArgs.promptMode, configureApp = runArgs.configureApp;
                    config = new config_1.default(configPath);
                    if (showHelp) {
                        (0, commands_1.help)();
                        process.exit(0);
                    }
...
if (require.main === module) {
    ...
    run(runArgs).then(function (weatherString) {
